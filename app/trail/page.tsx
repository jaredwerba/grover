      ...
      <section className="px-4 sm:px-6 py-16 max-w-3xl mx-auto w-full">
        <div className="border-t border-forest-mid/50 pt-12">
          ...
          <div className="space-y-4 text-cream-muted text-sm sm:text-base leading-relaxed">
            ...
            <p>
              CRAV was built to help you navigate Vermont&apos;s cannabis scene with confidence. Whether you&apos;re a lifelong Vermonter or just passing through on the way to the mountain, we want to connect you with the dispensaries and growers who call this state home.
            </p>
            <p>
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            {([
              { label: "Vermont Native", href: "/about#what-is-crav" },
