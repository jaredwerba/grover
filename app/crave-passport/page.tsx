...
export const metadata: Metadata = {
  title: "CRAVE Passport — Your Vermont Cannabis Trail | Cove",
  description:
    "Your personal CRAVE Passport — collect stickers from Vermont dispensaries by scanning their QR codes. 40 stops across four regional trails.",
  openGraph: {
    title: "CRAVE Passport — Your Vermont Cannabis Trail",
    description:
      "Scan stickers at Vermont dispensaries to fill up your digital CRAVE Passport.",
    url: "https://covebud.com/crave-passport",
    siteName: "Cove",
    type: "website",
  },
  alternates: {
    canonical: "https://covebud.com/crave-passport",
  },
};
    ...
    <main className="bg-forest-deep text-cream min-h-screen flex flex-col">
      ...
      <section className="px-4 sm:px-6 pt-8 pb-4 max-w-2xl mx-auto w-full text-center">
        ...
        <p className="text-cream-muted text-xs sm:text-sm leading-relaxed max-w-md mx-auto">
          Scan a CRAVE sticker at any participating dispensary to stamp
          your passport.
        </p>
        {/* Progress counter */}
