...
export const metadata: Metadata = {
  title: "About Cove — Vermont Cannabis Guide, COVE Trail & AI Concierge",
  description:
  ...
  openGraph: {
    ...
    description:
      "Vermont cannabis for first-timers, tourists, and curious consumers. COVE Trail dispensary map, strain library, and Cove AI — your Vermont cannabis companion.",
    ...
    <main className="min-h-screen bg-forest-deep text-cream">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-8 pb-6">
        ...
        <p className="text-cream-muted text-sm max-w-xl leading-relaxed">
          Learn how COVE Trail works, how to choose the right strain, and why AI makes the experience better.
        </p>
      </div>
