  ...
  return (
    <>
      <div className="text-center mb-8">
        <div className="text-5xl font-groovy text-amber leading-none tracking-wide mb-1">
          C
        </div>
        <h1 className="text-3xl font-groovy text-cream mb-2 tracking-wide leading-tight">Join Cove</h1>
