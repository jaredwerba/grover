...
export const AEO_SECTIONS: AboutSection[] = [
  {
    id: "what-is-cove-trail",
    question: "What is COVE Trail?",
    shortAnswer:
      "COVE Trail is Vermont's curated map of every licensed cannabis dispensary — built so you can browse locations, menus, and hours before you leave the house.",
    body: [
      {
        heading: "Vermont's cannabis guide, all in one place",
        text: "Vermont legalized adult-use cannabis in 2022. Since then, licensed dispensaries have opened across the state — from Burlington's South End to the Northeast Kingdom. COVE Trail plots every one of them on an interactive map with real addresses, phone numbers, and direct links to menus.",
      },
      {
        heading: "Medical and recreational, together",
        text: "Some dispensaries are adult-use only. Others hold medical registrations and serve patients with a Vermont Medical Cannabis Registry card. COVE Trail shows both — filter by type, or browse everything at once.",
      },
      {
        heading: "Built for Vermonters (and the people who visit them)",
        text: "Whether you live here or you're passing through on the way to Stowe, COVE Trail makes it easy to find the closest dispensary, compare their product selection, and get there without guessing. Every location on the trail is state-licensed and verified.",
      },
      {
        heading: "COVE Trail is part of Cove",
        text: "Cove is a Vermont cannabis companion app — COVE Trail is its map layer. Alongside the trail you'll find a strain library, an AI concierge, and resources for new and experienced cannabis consumers alike.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        heading: "Ask Cove AI",
        text: "Everyone's endocannabinoid system responds differently. Cove's AI can help you narrow down the right afternoon strain based on your tolerance, goals, and what's actually available at your nearest dispensary on COVE Trail.",
      },
    ],
  },
  {
    ...
    shortAnswer:
      "Vermont cannabis is legal for adults 21+. Start with a low dose, choose a dispensary on COVE Trail, tell your budtender it's your first time, and pick a low-THC product. Go slow — you can always use more, never less.",
    body: [
      {
        heading: "Vermont is a legal, regulated market",
        text: "Vermont legalized adult-use cannabis in 2022. Every dispensary on COVE Trail is licensed by the Vermont Cannabis Control Board — products are lab-tested for potency and contaminants. You're buying from a regulated, legal retailer, not the street.",
      },
      {
  ...
  },
  {
    ...
    body: [
      ...
      {
        heading: "Find a dispensary on COVE Trail",
        text: "Every licensed Vermont dispensary is mapped on COVE Trail — Cove's interactive dispensary directory. Whether you're skiing Stowe, hiking the Long Trail, or visiting Burlington's Church Street, there's likely a licensed dispensary nearby. Use COVE Trail to find locations, hours, and menus before you visit.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        text: "Before your first dispensary visit, ask Cove AI your questions — what strain, what format, what dose, what effects to expect. Coming in informed makes the dispensary experience less overwhelming and helps you make a better first choice. COVE Trail will show you which dispensaries are closest to where you are in Vermont.",
      },
    ],
  },
  {
